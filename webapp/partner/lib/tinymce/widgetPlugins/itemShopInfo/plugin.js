...
//            bind:function(){
//                setTimeout(function(){
//                    var topWin = window.top.document.getElementById("ui-tinymce-0_ifr").contentWindow;
//                    for(var i = 0, length = topWin.document.querySelectorAll('.tinymceItemShopInfoMain').length; i < length; i++) {
//                        topWin.document.querySelectorAll('.tinymceItemShopInfoMain')[i].addEventListener("click",function(){
//                            console.log(this.innerText.match(/^ /));
//                            if(this.innerText.length > 1 && (!this.innerText || (/^ /).match(this.innerText))){
