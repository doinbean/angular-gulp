...
(function () {
    ...
    function Foundation($rootScope, $state) {
        return {
            ...
            checkChineseOrEnglish: checkChineseOrEnglish,
            isObject: isObject,
        ...
        function getTimeZone() {
            var timezone,
                mydate = new Date(),
                getmtHours = 0 - mydate.getTimezoneOffset() / 60;
            if (getmtHours >= 0) {
                timezone = 'GMT+' + getmtHours;
            } else if (getmtHours < 0) {
                timezone = 'GMT' + getmtHours;
            }
            return timezone;
        }
        ...
        function checkChineseOrEnglish(value) {
            var Chinese = false,
                English = false,
                ChineseAndEnglish = false;
            var checkEnglish = /^[A-Za-z]+$/;
            var checkChinese = /^[\u4e00-\u9fa5·]+$/;
            if (checkEnglish.test(value)) {//英文
                English = true;
            } else if (checkChinese.test(value)) {//中文
                Chinese = true;
            } else {//不是全中文或全英文
                ChineseAndEnglish = true;
            }
            return {English: English, Chinese: Chinese, ChineseAndEnglish: ChineseAndEnglish};
        }
    }
})();