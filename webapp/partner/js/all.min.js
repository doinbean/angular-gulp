...
!function(){function n(n,r){function t(){var n,r=new Date,t=0-r.getTimezoneOffset()/60;return t>=0?n="GMT+"+t:t<0&&(n="GMT"+t),n}function e(n){for(var r,t={types:["Array","Boolean","Date","Number","Object","RegExp","String","Window","HTMLDocument"]},e=0;r=t.types[e++];)t[r]=function(n){return function(r){return Object.prototype.toString.call(r)=="[object "+n+"]"}}(r);return t.Object(n)}function u(n){var r={11:"北京",12:"天津",13:"河北",14:"山西",15:"内蒙古",21:"辽宁",22:"吉林",23:"黑龙江",31:"上海",32:"江苏",33:"浙江",34:"安徽",35:"福建",36:"江西",37:"山东",41:"河南",42:"湖北",43:"湖南",44:"广东",45:"广西",46:"海南",50:"重庆",51:"四川",52:"贵州",53:"云南",54:"西藏",61:"陕西",62:"甘肃",63:"青海",64:"宁夏",65:"新疆",71:"台湾",81:"香港",82:"澳门",91:"国外"},t=function(n){return e(n)!==!1&&(u(n)!==!1&&(o(n)!==!1&&i(n)!==!1))},e=function(n){var r=/(^\d{15}$)|(^\d{17}(\d|X)$)/;return r.test(n)!==!1},u=function(n){var t=n.substr(0,2);return void 0!=r[t]},o=function(n){var r=n.length;if("15"==r){var t=/^(\d{6})(\d{2})(\d{2})(\d{2})(\d{3})$/,e=n.match(t),u=e[2],o=e[3],i=e[4],c=new Date("19"+u+"/"+o+"/"+i);return a("19"+u,o,i,c)}if("18"==r){var f=/^(\d{6})(\d{4})(\d{2})(\d{2})(\d{3})([0-9]|X)$/,e=n.match(f),u=e[2],o=e[3],i=e[4],c=new Date(u+"/"+o+"/"+i);return a(u,o,i,c)}return!1},a=function(n,r,t,e){var u=new Date,o=u.getFullYear();if(e.getFullYear()==n&&e.getMonth()+1==r&&e.getDate()==t){var a=o-n;return a>=0&&a<=130}return!1},i=function(n){n=c(n);var r=n.length;if("18"==r){var t,e,u=new Array(7,9,10,5,8,4,2,1,6,3,7,9,10,5,8,4,2),o=new Array("1","0","X","9","8","7","6","5","4","3","2"),a=0;for(t=0;t<17;t++)a+=n.substr(t,1)*u[t];return e=o[a%11],e==n.substr(17,1)}return!1},c=function(n){if("15"==n.length){var r,t=new Array(7,9,10,5,8,4,2,1,6,3,7,9,10,5,8,4,2),e=new Array("1","0","X","9","8","7","6","5","4","3","2"),u=0;for(n=n.substr(0,6)+"19"+n.substr(6,n.length-6),r=0;r<17;r++)u+=n.substr(r,1)*t[r];return n+=e[u%11]}return n};return t(n)}function o(n){var r;if("object"==typeof n)if(null===n)r=null;else if(n instanceof Array){r=[];for(var t=0,e=n.length;t<e;t++)r.push(o(n[t]))}else{r={};for(var u in n)r[u]=o(n[u])}else r=n;return r}function a(r,t){return n.$on(r,t)}function i(r,t){return n.$broadcast(r,t)}function c(n,t){var e=t?t:"";r.go(n,{data:e})}function f(){r.go("transport.list")}function s(){}function l(n){var r=n.replace(/[\r\n\t]/g,"");return r}function g(n){var r=!1,t=!1,e=!1,u=/^[A-Za-z]+$/,o=/^[\u4e00-\u9fa5·]+$/;return u.test(n)?t=!0:o.test(n)?r=!0:e=!0,{English:t,Chinese:r,ChineseAndEnglish:e}}return{on:a,publish:i,go:c,goHome:f,clone:o,checkIdCard:u,goLogin:s,replaceSpecialSymbol:l,checkChineseOrEnglish:g,isObject:e,getTimeZone:t}}angular.module("app.core").factory("Foundation",["$rootScope","$state",n])}();
!function(){function n(n,e,r,t,a){function o(n){var e=[];for(var r in n)n.hasOwnProperty(r)&&e.push(encodeURIComponent(r)+"="+encodeURIComponent(n[r]));return e.join("&")}function i(t,a){var i=t,d={"Content-Type":"application/x-www-form-urlencoded;charset=utf-8"};return n({method:"POST",url:i,data:o(a),headers:d}).then(function(n){return n=n.data,"SUCCESS"==n.code?n:(r.error(n.message||"系统错误"),$("loading").find(".spinner").addClass("ng-hide"),e.reject(n))},function(n){return $("loading").find(".spinner").addClass("ng-hide"),r.error(n.message||"系统错误"),e.reject(n)})}function d(t,a){return n({dataType:"json",method:"GET",params:a,url:t}).then(function(n){return n=n.data,"SUCCESS"==n.code?n:e.reject()},function(n){return r.error(n.data.message||"系统错误"),e.reject(n)})}var u={"package":{getPlanList:"/b/packet/relate_packet_item.do"}},c={upload:"/upload/upload_file.do",uploadImg:"/upload/upload_image.do"};for(var p in u){var f=u[p];c[p]={};for(var s in f){var l=f[s];c[p][s]=function(n){return function(){var e=n;return i(e,arguments[0])}}(l)}}return{NormalApi:c,post:i,get:d,apiList:u}}angular.module("app.core").factory("Api",["$http","$q","Notification","Foundation",n])}();
