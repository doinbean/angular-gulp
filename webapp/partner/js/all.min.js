...
!function(){function n(n,r,e,t,a){function o(n){var r=[];for(var e in n)n.hasOwnProperty(e)&&r.push(encodeURIComponent(e)+"="+encodeURIComponent(n[e]));return r.join("&")}function i(t,a){var i=t,u={"Content-Type":"application/x-www-form-urlencoded;charset=utf-8"};return n({method:"POST",url:i,data:o(a),headers:u}).then(function(n){return n=n.data,"SUCCESS"==n.code?n:(e.error(n.message||"系统错误"),$("loading").find(".spinner").addClass("ng-hide"),r.reject(n))},function(n){return $("loading").find(".spinner").addClass("ng-hide"),e.error(n.message||"系统错误"),r.reject(n)})}function u(t,a){return n({dataType:"json",method:"GET",params:a,url:t}).then(function(n){return n=n.data,"SUCCESS"==n.code?n:r.reject()},function(n){return e.error(n.data.message||"系统错误"),r.reject(n)})}var c={"package":{getPlanList:""}},d={};for(var s in c){var f=c[s];d[s]={};for(var p in f){var l=f[p];d[s][p]=function(n){return function(){var r=n;return i(r,arguments[0])}}(l)}}return{NormalApi:d,post:i,get:u,apiList:c}}angular.module("app.core").factory("Api",["$http","$q","Notification","Foundation",n])}();
